<?php
 session_start();
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST")
  {
        ...
        $sql_salary = "UPDATE `indus_shop`.`employee` SET `salary` = '$salary' WHERE `employee`.`emp_id` = '$person_id';";
        $result_salary = mysql_query($sql_salary);

        if($result_contact and $result_address and $result_person and $result_salary){
          //echo("succeded");
